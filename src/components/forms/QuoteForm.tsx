...
export default function QuoteForm() {
  ...
  const handleManualFormSubmit = async (data: z.infer<typeof manualInputSchema>) => {
    ...
    setProductInfo({
      ...
      price: data.price,
      imageUrl: data.productImage || "https://source.unsplash.com/300x300/?product",
  ...
  const handleCloseCourierModal = () => {
    ...
    setTimeout(() => {
      try {
        ...
        setStep(2);
        console.log("Form step after:", step);
  ...
  return (
    <section id="quote" className="w-full py-12 md:py-24 lg:py-32 bg-gray-50">
